...
class HopperOutputParserTest(unittest.TestCase):
    def test_parse_dense_xqa_output(self):
...
"""
        self.assertEqual(parse_dense(text), {16384: 0.714068, 65536: 2.828993})


    def test_parse_blasst_xqa_output(self):
